...
class TestDjangoEncryptField:
    ...
    def test_passed_string_value(self, connection):
        connection.Database.Binary.return_value = b'gAAAAABg1vz2rLbNvztnC8p2hQbBGzrnyuGN772bEY5' \
    ...
    @pytest.mark.parametrize(('passed', 'passed_type'), [(1, int), ({'value': 1}, dict), ([1, 'value'], list)])
